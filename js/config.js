...
var CONFIG = window.CONFIG = {
  ...
  // Comprehensive Indian Equities & Indices Catalog for Search & Autocomplete
  INDIAN_SECURITIES_CATALOG: [
    ...
    { symbol: 'TATASTEEL.NS', name: 'Tata Steel Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATAMOTORS.NS', name: 'Tata Motors Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATAPOWER.NS', name: 'Tata Power Company Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATACONSUM.NS', name: 'Tata Consumer Products Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATACHEM.NS', name: 'Tata Chemicals Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATACOMM.NS', name: 'Tata Communications Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TATAELXSI.NS', name: 'Tata Elxsi Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ITC.NS', name: 'ITC Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'LT.NS', name: 'Larsen & Toubro Ltd.', type: 'Equity', exchange: 'NSE' },
    ...
    { symbol: 'AXISBANK.NS', name: 'Axis Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'PNB.NS', name: 'Punjab National Bank', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BANKBARODA.NS', name: 'Bank of Baroda', type: 'Equity', exchange: 'NSE' },
    { symbol: 'CANBK.NS', name: 'Canara Bank', type: 'Equity', exchange: 'NSE' },
    { symbol: 'IDFCFIRSTB.NS', name: 'IDFC First Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'FEDERALBNK.NS', name: 'Federal Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'INDUSINDBK.NS', name: 'IndusInd Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BANDHANBNK.NS', name: 'Bandhan Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'AUBANK.NS', name: 'AU Small Finance Bank Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ADANIENT.NS', name: 'Adani Enterprises Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ADANIPORTS.NS', name: 'Adani Ports & SEZ Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ADANIGREEN.NS', name: 'Adani Green Energy Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ADANIPOWER.NS', name: 'Adani Power Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ADANIENSOL.NS', name: 'Adani Energy Solutions Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ATGL.NS', name: 'Adani Total Gas Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'AWL.NS', name: 'Adani Wilmar Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'WIPRO.NS', name: 'Wipro Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HCLTECH.NS', name: 'HCL Technologies Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TECHM.NS', name: 'Tech Mahindra Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'LTIM.NS', name: 'LTIMindtree Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'PERSISTENT.NS', name: 'Persistent Systems Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'COFORGE.NS', name: 'Coforge Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'MARUTI.NS', name: 'Maruti Suzuki India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'M&M.NS', name: 'Mahindra & Mahindra Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BAJAJ-AUTO.NS', name: 'Bajaj Auto Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HEROMOTOCO.NS', name: 'Hero MotoCorp Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'EICHERMOT.NS', name: 'Eicher Motors Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'SUNPHARMA.NS', name: 'Sun Pharmaceutical Industries Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'CIPLA.NS', name: 'Cipla Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'DRREDDY.NS', name: "Dr. Reddy's Laboratories Ltd.", type: 'Equity', exchange: 'NSE' },
    { symbol: 'DIVISLAB.NS', name: "Divi's Laboratories Ltd.", type: 'Equity', exchange: 'NSE' },
    { symbol: 'LUPIN.NS', name: 'Lupin Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ASIANPAINT.NS', name: 'Asian Paints Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BERGEPAINT.NS', name: 'Berger Paints India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BAJFINANCE.NS', name: 'Bajaj Finance Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BAJAJFINSV.NS', name: 'Bajaj Finserv Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TITAN.NS', name: 'Titan Company Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ULTRACEMCO.NS', name: 'UltraTech Cement Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'GRASIM.NS', name: 'Grasim Industries Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'SHREECEM.NS', name: 'Shree Cement Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'AMBUJACEM.NS', name: 'Ambuja Cements Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'NTPC.NS', name: 'NTPC Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ONGC.NS', name: 'Oil & Natural Gas Corporation', type: 'Equity', exchange: 'NSE' },
    { symbol: 'POWERGRID.NS', name: 'Power Grid Corporation of India', type: 'Equity', exchange: 'NSE' },
    { symbol: 'COALINDIA.NS', name: 'Coal India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BPCL.NS', name: 'Bharat Petroleum Corporation Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'IOC.NS', name: 'Indian Oil Corporation Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'GAIL.NS', name: 'GAIL (India) Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HINDPETRO.NS', name: 'Hindustan Petroleum Corporation', type: 'Equity', exchange: 'NSE' },
    { symbol: 'NESTLEIND.NS', name: 'Nestle India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BRITANNIA.NS', name: 'Britannia Industries Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'DABUR.NS', name: 'Dabur India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'GODREJCP.NS', name: 'Godrej Consumer Products Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'JSWSTEEL.NS', name: 'JSW Steel Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HINDALCO.NS', name: 'Hindalco Industries Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'VEDL.NS', name: 'Vedanta Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BEL.NS', name: 'Bharat Electronics Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HAL.NS', name: 'Hindustan Aeronautics Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'DLF.NS', name: 'DLF Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'GODREJPROP.NS', name: 'Godrej Properties Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'OBEROIRLTY.NS', name: 'Oberoi Realty Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'TRENT.NS', name: 'Trent Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ZOMATO.NS', name: 'Zomato Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'JIOFIN.NS', name: 'Jio Financial Services Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'PAYTM.NS', name: 'One97 Communications (Paytm)', type: 'Equity', exchange: 'NSE' },
    { symbol: 'NYKAA.NS', name: 'FSN E-Commerce (Nykaa)', type: 'Equity', exchange: 'NSE' },
    { symbol: 'POLICYBZR.NS', name: 'PB Fintech (Policybazaar)', type: 'Equity', exchange: 'NSE' },
    { symbol: 'DMART.NS', name: 'Avenue Supermarts Ltd. (DMart)', type: 'Equity', exchange: 'NSE' },
    { symbol: 'VBL.NS', name: 'Varun Beverages Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'PIDILITIND.NS', name: 'Pidilite Industries Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'HAVELLS.NS', name: 'Havells India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'SIEMENS.NS', name: 'Siemens Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'ABB.NS', name: 'ABB India Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'MUTHOOTFIN.NS', name: 'Muthoot Finance Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'CHOLAFIN.NS', name: 'Cholamandalam Investment & Finance', type: 'Equity', exchange: 'NSE' },
    { symbol: 'RECLTD.NS', name: 'REC Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'PFC.NS', name: 'Power Finance Corporation', type: 'Equity', exchange: 'NSE' },
    { symbol: 'IREDA.NS', name: 'Indian Renewable Energy Dev Agency', type: 'Equity', exchange: 'NSE' },
    { symbol: 'IRCTC.NS', name: 'Indian Railway Catering & Tourism', type: 'Equity', exchange: 'NSE' },
    { symbol: 'IRFC.NS', name: 'Indian Railway Finance Corporation', type: 'Equity', exchange: 'NSE' },
    { symbol: 'RVNL.NS', name: 'Rail Vikas Nigam Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'MAZDOCK.NS', name: 'Mazagon Dock Shipbuilders Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'COCHINSHIP.NS', name: 'Cochin Shipyard Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: 'BHEL.NS', name: 'Bharat Heavy Electricals Ltd.', type: 'Equity', exchange: 'NSE' },
    { symbol: '^NSEI', name: 'NIFTY 50 Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^BSESN', name: 'BSE SENSEX Index', type: 'Index', exchange: 'BSE' },
    { symbol: '^NSEBANK', name: 'NIFTY BANK Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXIT', name: 'NIFTY IT Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^INDIAVIX', name: 'INDIA VIX', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXAUTO', name: 'NIFTY Auto Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXFMCG', name: 'NIFTY FMCG Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXPHARMA', name: 'NIFTY Pharma Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXMETAL', name: 'NIFTY Metal Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXPSUBANK', name: 'NIFTY PSU Bank Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXREALTY', name: 'NIFTY Realty Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXFIN', name: 'NIFTY Financial Services', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXMEDIA', name: 'NIFTY Media Index', type: 'Index', exchange: 'NSE' },
    { symbol: '^CNXCOMMODITIES', name: 'NIFTY Commodities Index', type: 'Index', exchange: 'NSE' },
  ],
